...
global.owner = process.env.OWNER_NUMBER  || '237698947449';  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=PckWlCaK#PWCedqOm1pJpyIrWFo-7cdNqHhHJ28xvtVPcMJH1aI0' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "237698947449,237651506147" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'Vladimir' ,
